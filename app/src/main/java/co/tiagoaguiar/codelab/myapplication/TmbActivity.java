...
public class TmbActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSend.setOnClickListener(v -> {
            ...
            double tmbResult = tmbResponse(result);
            Log.d("Teste", "" + tmbResult);

            AlertDialog dialog = new AlertDialog.Builder(TmbActivity.this)
                    .setTitle(getString(R.string.tmb_response, tmbResult))
                    .setMessage(getString(R.string.tmb_response, tmbResult))
                    .setPositiveButton(android.R.string.ok, (dialogInterface, i) -> {
                    })
                    .setNegativeButton(R.string.save, ((dialog1, which) -> {

                        new Thread(() -> {
                            long caldId = SqlHelper.getInstance(TmbActivity.this).addItem("tmb", tmbResult);
                            runOnUiThread(() -> {
                                if (caldId > 0) {
